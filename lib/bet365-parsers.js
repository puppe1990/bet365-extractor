...
export function extractStatsFromVisibleText(text) {
...
export function finalizeMatchData(match, visibleText, meta, extractedAt) {
...
export function finalizeMatchWithMarkets(match, odds, visibleText, meta, extractedAt) {
