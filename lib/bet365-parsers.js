...
export function extractScoreboardStatusNear(flat, endIndex = 0) {
...
export function inferMatchStatusFromScoreboard(match, scoreboardText = "") {
...
export function isTotalsLineValue(s) {
...
export function isCornerBettingMarket(market) {
...
export function isCornerTotalRangeSelection(selection, market) {
...
export function isTotalsDirectionLine(line) {
...
export function isValidTotalsLine(value, options = {}) {
...
export function isHandicapLineToken(line) {
  return /^[+-]\d+([.,]5)?$/.test(normalize(line));
}

export function isHandicapBettingMarket(market) {
  return /Handicap/i.test(normalize(market));
}

export function isHandicapSelectionLine(line, lines, index) {
...
export function composeHandicapSelection(name, token) {
...
export function isCornerBettingSubMarket(line) {
  const s = normalize(line);
