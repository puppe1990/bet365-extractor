...
export const SIDE_PANEL_TAB_KEYS = ["stats", "playerStats", "timeline", "lineup"];
...
export function parseTimelineFromText(text) {
...
export function extractSidePanelFromTexts(textByTab = {}) {
